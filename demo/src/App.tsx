...
const INITIAL_GYMS: Gym[] = [
  ...
  },
  {
    ...
    name: 'イージーフィット 新宿東口',
    address: '東京都新宿区（デモ）',
    equipment: ['マシン', 'ケーブル', 'ダンベル', 'ヨガマット', '自重'],
  },
  {
    id: 'g5',
    name: 'ゴールドジム お茶の水',
    address: '東京都千代田区（デモ）',
    equipment: ['ラック', 'バーベル', 'ダンベル', 'ケーブル', 'マシン', 'ヨガマット', '自重'],
  },
  {
    id: 'g6',
    name: 'カーブス 吉祥寺',
  ...
  {
    id: 'g7',
    name: 'エニタイムフィットネス 横浜西口',
    address: '神奈川県横浜市西区（デモ）',
    equipment: ['ラック', 'バーベル', 'ダンベル', 'マシン', 'ヨガマット', '自重'],
  },
  {
    id: 'g8',
    name: 'JOYFIT さいたま新都心',
    address: '埼玉県さいたま市大宮区（デモ）',
    equipment: ['ラック', 'バーベル', 'ダンベル', 'ケーブル', 'マシン', 'ヨガマット'],
  },
  {
    id: 'g9',
  ...
  },
  {
    ...
    name: 'ライズアップ 池袋',
    address: '東京都豊島区（デモ）',
    equipment: ['ダンベル', 'ケーブル', 'マシン', 'ヨガマット', '自重'],
  },
  {
    id: 'g11',
    name: 'パーソナルスタジオ 青葉台',
    address: '神奈川県横浜市青葉区（デモ）',
    equipment: ['ラック', 'バーベル', 'ダンベル', 'ケーブル', 'ヨガマット', '自重'],
  },
  {
    id: 'g12',
    name: 'ホームジム 代々木公園前',
    address: '東京都渋谷区（デモ）',
    equipment: ['ダンベル', 'ヨガマット', '自重'],
  },
  {
    id: 'g13',
    name: 'スポーツクラブ NAS 船橋',
  ...
  },
  {
    id: 'g15',
    name: 'チキンジム 札幌大通',
    address: '北海道札幌市中央区（デモ）',
    equipment: ['ラック', 'バーベル', 'ダンベル', 'ケーブル', 'マシン', '自重'],
  },
]
